        ...
        **kwargs
        ...
        """Screen for companies meeting various criteria.
            ...
            exchange : str
                ...
                Choices for finviz: 'all', 'amex', 'nasdaq', 'nyse'
            ...
            sector : str
                ...
                Choices for finviz: 'all', 'energy', 'materials', 'industrials', 'consumer_cyclical', 'consumer_defensive', 'financial'
                    'healthcare', 'technology', 'communication_services', 'utilities', 'real_estate'
        ...
        Nano - < 50M (provider: finviz, nasdaq)
                Choices for finviz: 'all', 'mega', 'large', 'large_over', 'large_under', 'mid', 'mid_over', 'mid_under', 'small'
                    'small_over', 'small_under', 'micro', 'micro_over', 'micro_under', 'nano'
            recommendation : str
            ...
            filters_dict : Union[Dict, str, None]
