#!/usr/bin/env python3
"""
SPX CFD Testing Framework - Command Line Test Runner

This script executes the comprehensive test suite for the SPX CFD strategy
...
Options:
    --category <category>    Run tests for specific category (data, parameters, trading, etc.)
...
class TestRunner:
    """Command line test runner for SPX CFD testing framework."""
...
"""
    ...
    def run_tests(self, args):
        ...
        try:
            ...
            # Parse full output for any missed tests
            full_output = '\n'.join(output_lines)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SPX CFD Testing Framework - Command Line Test Runner",
