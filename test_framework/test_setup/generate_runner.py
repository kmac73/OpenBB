#!/usr/bin/env python3
"""
OpenBB Test Framework Generator - Test Runner Generator
Generates the command line test runner script.
"""
...
class RunnerGenerator:
    """Generates the test runner script."""
    
    def generate_runner(self, framework_dir: Path, framework_name: str):
        """Generate the run_tests.py script."""
        print(f"🏃 Generating test runner for {framework_name}")
        
        runner_content = f'''#!/usr/bin/env python3
"""
{framework_name} Testing Framework - Command Line Test Runner

This script executes the comprehensive test suite for the {framework_name} strategy
...
class TestRunner:
    """Command line test runner for {framework_name} testing framework."""
    ...
    def print_header(self):
        ...
        header = f\"\"\"
{{'='*80}}
🧪 {framework_name.upper()} TESTING FRAMEWORK
{{'='*80}}
...
\"\"\"
    ...
    def generate_report_only(self):
        ...
        try:
            ...
            print("="*80)
            print(f"Framework: {{results.get('framework', '{framework_name}')}}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="{framework_name} Testing Framework - Command Line Test Runner",
...
if __name__ == '__main__':
    sys.exit(main())'''
        ...
        runner_file = framework_dir / "run_tests.py"
        runner_file.write_text(runner_content)
        
        print("✅ Test runner generated")


def main():
    parser = argparse.ArgumentParser(description="Generate test runner script")
    ...
    generator.generate_runner(Path(args.framework_dir), args.framework_name)
